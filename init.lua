...
vim.g.have_nerd_font = true -- martin - false to true
...
vim.opt.relativenumber = true -- martin - uncommented
...
vim.keymap.set('n', '<right>', '<cmd>echo "Use l to move!!"<CR>') -- martin - uncommented
vim.keymap.set('n', '<up>', '<cmd>echo "Use k to move!!"<CR>') -- martin - uncommented
vim.keymap.set('n', '<down>', '<cmd>echo "Use j to move!!"<CR>') -- martin - uncommented
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          ['<C-n>'] = cmp.mapping.select_next_item(), -- martin
          -- Select the [p]revious item
          ['<C-p>'] = cmp.mapping.select_prev_item(), -- martin
          ...
          -- ['<CR>'] = cmp.mapping.confirm { select = true }, -- martin
          -- ['<Tab>'] = cmp.mapping.select_next_item(), -- martin
          -- ['<S-Tab>'] = cmp.mapping.select_prev_item(), -- martin
